...
"""
import data_analysis.analyze_characteristics as analyse_characteristics
...
def main():
    ...
    print('start analysing root class characteristics')
    analyse_characteristics.main()
    print('finished analysing root class characteristics')
